...
func (sos *SendOnlySubstream) RawChans() (<-chan TypedJSON, chan<- EventToUser) {
...
func (ros *ReceiveOnlySubstream) ReceiveChan() <-chan TypedJSON {
	return ros.fromUser
}
...
func (ss *Substream) RawChans() (<-chan TypedJSON, chan<- EventToUser) {
